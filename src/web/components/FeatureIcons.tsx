export function GraphRAGIcon() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <radialGradient id="glow" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(100 100) rotate(90) scale(60)">
...
export function DAGIcon() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Flow Lines */}
      <path d="M40 100 C 70 100, 70 60, 100 60 C 130 60, 130 100, 160 100" stroke="url(#flow)" stroke-width="2" fill="none" />
      <path d="M40 100 C 70 100, 70 140, 100 140 C 130 140, 130 100, 160 100" stroke="url(#flow)" stroke-width="2" fill="none" />
      <path d="M40 100 L 160 100" stroke="url(#flow)" stroke-width="2" stroke-dasharray="4 4" fill="none" opacity="0.5" />
...
export function SandboxIcon() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Hexagon Container */}
      <path d="M100 30 L 160.6 65 V 135 L 100 170 L 39.4 135 V 65 L 100 30 Z" 
            stroke="#FFB86F" stroke-width="2" fill="#FFB86F" fill-opacity="0.05" />
      
      {/* Inner Shield/Lock Shape */}
      <path d="M100 60 L 140 80 V 110 C 140 135 125 150 100 160 C 75 150 60 135 60 110 V 80 L 100 60 Z"
            stroke="#FFB86F" stroke-width="2" fill="#0a0908" />
            
      {/* Code Symbol */}
      <path d="M85 100 L 75 110 L 85 120 M 115 100 L 125 110 L 115 120 M 95 125 L 105 95"
            stroke="#FFB86F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
