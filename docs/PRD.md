...
**Author:** BMad **Date:** 2025-11-03 (Updated: 2025-12-04 - Epic 7 & 8 added) **Project Level:** 3
**Target Scale:** Complex System - 10 epics, 50+ stories (baseline + adaptive features + emergent
capabilities + hypergraph viz)
...
AgentCards se différencie par une approche **PGlite-first, zero-config, et double optimisation** :
...
- **FR016:** Le système doit pouvoir lire le mcp.json existant de Claude Code et générer
  automatiquement la configuration AgentCards correspondante
...
**Objectif:** Passer d'une configuration MCP saturant le contexte à AgentCards avec context optimisé
...
Pour un outil backend comme AgentCards, l'UX se concentre sur la **Developer Experience (DX)**.
Principes clés:
...
**Objectif:** Transformer AgentCards en système où les capabilities **émergent de l'usage** plutôt
que d'être pré-définies. Claude devient un **orchestrateur de haut niveau** qui délègue l'exécution
à AgentCards, récupérant des capabilities apprises et des suggestions proactives basées sur les
