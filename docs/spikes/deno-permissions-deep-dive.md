...
8. [Best Practices for AgentCards](#best-practices-for-agentcards)
...
**AgentCards usage:** Sandbox should NEVER have write access. All writes happen in host process.
...
**AgentCards usage:** Sandbox has NO FFI access. This is critical for security.
...
**AgentCards usage:** Workers use `permissions: "none"` and communicate via message passing.
...
--allow-read=/home/user/.agentcards/temp/abc123.ts
```
...
**AgentCards usage:** This is our Story 3.2 architecture (message passing bridge).
...
**AgentCards usage:** This is our Story 3.1 sandbox executor.
...
**Conclusion:** Permission overhead is negligible for AgentCards use case (<1ms per execution).
...
## Checklist for AgentCards Sandbox
