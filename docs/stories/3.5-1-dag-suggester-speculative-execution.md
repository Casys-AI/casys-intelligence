...
As an AI agent, I want AgentCards to predict and execute likely next actions speculatively, so that
I get instant responses without waiting for execution.
...
differentiator of AgentCards - 0ms perceived latency when speculation hits.
