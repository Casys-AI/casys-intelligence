...
- Example workflow: `{project-root}/bmad/bmb/reference/workflows/meal-prep-nutrition/workflow.md`
- Step examples from same workflow's steps folder
- Architecture guide: `{project-root}/bmad/bmb/docs/workflows/architecture.md`
