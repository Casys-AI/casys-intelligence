...
- `{project-root}/bmad/bmb/docs/workflows/step-template.md` - Step file structure
- `{project-root}/bmad/bmb/docs/workflows/workflow-template.md` - Workflow configuration
- `{project-root}/bmad/bmb/docs/workflows/architecture.md` - Architecture principles
...
```
Read: {project-root}/bmad/bmb/docs/workflows/step-template.md
```
