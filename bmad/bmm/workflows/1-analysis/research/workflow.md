...
capabilities with current {{current_year}} data and rigorous source verification, while you bring
the domain expertise and research direction.
...
**Note:** All research workflows emphasize current web data with {{current_year}} searches and
