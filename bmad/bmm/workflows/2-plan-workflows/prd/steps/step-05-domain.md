...
`{project-root}/bmad/bmm/workflows/2-plan-workflows/prd/steps/step-06-innovation.md`.
...
- Execute {project-root}/bmad/core/workflows/party-mode/workflow.md with the current domain
  requirements
...
`{project-root}/bmad/bmm/workflows/2-plan-workflows/prd/steps/step-06-innovation.md` if:
