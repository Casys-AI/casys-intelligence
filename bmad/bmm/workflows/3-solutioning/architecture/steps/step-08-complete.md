...
Would you like to create a `project_context.md` file? This is a concise, optimized guide for AI
...
The workflow will collaborate with you to create an optimized `project_context.md` file that AI
